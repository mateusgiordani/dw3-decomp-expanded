/*
 * CARDGAME:0x8009d310 CARDGAME_F0x8009d310
 * 560 bytes at CARDGAME.PRO offset 0x1a660 (overlay loaded at 0x80082cb0).
 *
 ...
 *  Link        .text at 0x8009d310
 *  Symbols     CARDGAME_F0x8009bba8=0x8009bba8 CARDGAME_F0x8009beac=0x8009beac
 *              CARDGAME_F0x8009bf5c=0x8009bf5c CARDGAME_F0x8009c054=0x8009c054
 *              CARDGAME_F0x8009c0dc=0x8009c0dc CARDGAME_F0x8009c124=0x8009c124
 *              CARDGAME_F0x8009c174=0x8009c174 CARDGAME_F0x8009c1cc=0x8009c1cc
 *              CARDGAME_F0x8009c214=0x8009c214 CARDGAME_F0x8009c510=0x8009c510
 *              CARDGAME_F0x8009c5d8=0x8009c5d8 CARDGAME_F0x8009c654=0x8009c654
 *              CARDGAME_F0x8009c6e8=0x8009c6e8 CARDGAME_F0x8009c770=0x8009c770
 *              CARDGAME_F0x8009c904=0x8009c904 CARDGAME_F0x8009c938=0x8009c938
 *              CARDGAME_F0x8009c9a0=0x8009c9a0 CARDGAME_F0x8009ca3c=0x8009ca3c
 *              CARDGAME_F0x8009cda4=0x8009cda4 CARDGAME_F0x8009ce28=0x8009ce28
 *              CARDGAME_F0x8009ce94=0x8009ce94 CARDGAME_F0x8009cf60=0x8009cf60
 *              CARDGAME_F0x8009cfbc=0x8009cfbc CARDGAME_F0x8009d15c=0x8009d15c
 *              CARDGAME_LAB_8009be40=0x8009be40
 *              CARDGAME_LAB_8009be78=0x8009be78
 *              CARDGAME_LAB_8009bfcc=0x8009bfcc
 *              CARDGAME_LAB_8009c010=0x8009c010
 *              CARDGAME_LAB_8009c16c=0x8009c16c
 *              CARDGAME_LAB_8009c25c=0x8009c25c
 *              CARDGAME_LAB_8009c264=0x8009c264
 *              CARDGAME_LAB_8009c2d0=0x8009c2d0
 *              CARDGAME_LAB_8009c350=0x8009c350
 *              CARDGAME_LAB_8009c3c0=0x8009c3c0
 *              CARDGAME_LAB_8009c438=0x8009c438
 *              CARDGAME_LAB_8009c4a4=0x8009c4a4
 *              CARDGAME_LAB_8009c4d8=0x8009c4d8
 *              CARDGAME_LAB_8009c7f8=0x8009c7f8
 *              CARDGAME_LAB_8009ca80=0x8009ca80
 *              CARDGAME_LAB_8009cae0=0x8009cae0
 *              CARDGAME_LAB_8009cc4c=0x8009cc4c
 *              CARDGAME_LAB_8009cdfc=0x8009cdfc EXE_F0x80014504=0x80014504
 *              FUN_80098864=0x80098864 FUN_800a2f00=0x800a2f00
 *  Compare     560 bytes from 0x8009d310 against the PAL overlay
 *  Verify      python tools/card_verify.py --only CARDGAME:0x8009d310
 */
/*
 * Recovery notes (kept from the recovery work; historical, not re-verified).
 *
 * Prologue 27bdffe8 addiu sp,-0x18 ; sw s0,0x10(sp) ; move s0,a0 ; lui
 * a0,0x800a ; addiu a0,-0x4458 (=0x8009bba8) ; li a1,0xf48 ; sw ra,0x14(sp) ;
 * jal EXE:0x80014504 ; ori a2,0x38 (delay)
 *
 * Body: 42x (lui v1,0x800a ; addiu v1,neg ; sw v1,off(v0)) table stores plus sw
 * s0,0x50(v0) after the 0xf04 store; v0 is the EXE allocator result reused
 * directly Epilogue lw ra,0x14(sp) ; lw s0,0x10(sp) ; jr ra ; addiu sp,+0x18
 *
 * Next function CARDGAME:0x8009d540 at +0x230 (prologue addiu sp,-0x18)
 * confirms size 0x230 is self-contained.
 *
 * Caller: one direct jal from FUN_800a2f00 at 0x800a2f94 (in-overlay init
 * path); registered callbacks are reached via this table (DATA xrefs), not
 * direct calls.
 *
 * Slot map (offset -> CARDGAME pointer): ea0->cae0 ea4->be40 ea8->be78
 * eac->beac eb0->bf5c eb8->cc4c eb4->cda4 ee4->c054 ee8->c0dc ef0->c16c
 * eec->c124 ef4->c174 ef8->c1cc efc->c214 f00->c25c ed8->8864 edc->bfcc
 * ee0->c010 f08->c9a0 f0c->ca3c f10->ca80 f2c->c654 f30->c6e8 f34->c770
 * f38->c7f8 f28->c5d8 f14->c510 f18->cdfc f1c->ce28 f20->c904 f24->c938
 * f04->ce94 050->arg ec4->c350 ec8->c2d0 ebc->c438 ed0->c4a4 ed4->c4d8
 * ec0->c3c0 ecc->c264 f3c->cfbc f40->cf60 f44->d15c (all 0x8009xxxx; 0x80098864
 * is the only out-of-family slot).
 *
 ...
 * through cc1's HIGH/LO_SUM pre-split (lui 0x8009 + ori) on every pinned cc1,
 * so the slots must reference extern symbols (resolved to absolute addresses at
 * link) to reproduce the observed expansion. Function slots use their Ghidra
 * canonical names; LAB_ slots use positional externs (address encoded in the
 * name, not promoted symbols, no CSV changes).
 */
