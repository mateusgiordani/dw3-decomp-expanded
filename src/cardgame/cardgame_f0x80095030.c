/*
 * CARDGAME:0x80095030 CARDGAME_F0x80095030
 * 348 bytes at CARDGAME.PRO offset 0x12380 (overlay loaded at 0x80082cb0).
 *
 ...
 *  Link        .text at 0x80095030
 *  Symbols     DAT_8004B7D0=0x8004b7d0
 *  Compare     348 bytes from 0x80095030 against the PAL overlay
 *  Verify      python tools/card_verify.py --only CARDGAME:0x80095030
 */
