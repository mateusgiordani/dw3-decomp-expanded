/* CARDGAME:0x80090cd8, PAL-SLES-03936: 2284 bytes plus 40-byte switch table.
 * Verified base 0x80082cb0; text file offset 0xe028; table 0x80083554.
 * Callback offsets and field views follow PAL accesses; semantics remain partial.
 * Exact with PsyQ GCC 2.8.1-sn32-4.0.0010 / ASPSX 2.79, O2 -G0.
 * Evidence: docs/c-matching-guide/submissions/cardgame-80090cd8/strategy-r9-astra.md
 */
#include <stdint.h>
