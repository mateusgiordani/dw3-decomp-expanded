/*
 * CARDGAME:0x800919fc CARDGAME_F0x800919fc
 * 624 bytes at CARDGAME.PRO offset 0xed4c (overlay loaded at 0x80082cb0).
 *
 ...
 *  Link        .text at 0x800919fc
 *  Symbols     CARDGAME_F0x80084320=0x80084320 CARDGAME_F0x8009170c=0x8009170c
 *              CARDGAME_F0x800a0844=0x800a0844
 *  Compare     624 bytes from 0x800919fc against the PAL overlay
 *  Verify      python tools/card_verify.py --only CARDGAME:0x800919fc
 */
/*
 ...
 *
 * 1 caller: CARDGAME:0x80084804 (in CARDGAME_F0x80084320; a0=ptr, a1=ptr,
 * a2=idx).
 *
 ...
 * lw p2+0xf3c (p2,u7,*(short*)(pb+u6*14+2)) ; lw p2+0xea0 (p2,idx,6,cnt) ; lw
 * p2+0xf24 (p2,u7,0x14,0x1000,0x1000 via sp+0x10).
 *
