/* CARDGAME:0x8008eec8 — 492 bytes, base PAL 0x80082cb0.
   exact_byte_match com psyq-gcc-2.8.1-sn32-4.0.0010 + aspsx-2.79,
   -O2 -G0 -fno-strength-reduce -mno-split-addresses.
   Simbolos: func_8001ebf8=0x8001ebf8, D0x800a58f4=0x800a58f4.
   k e o flag de skip (a0); j e o indice do scan. h e int para o lh. */
#include <stdint.h>
