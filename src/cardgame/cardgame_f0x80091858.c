/* CARDGAME:0x80091858, 420 PAL bytes at base 0x80082cb0.
   The 88-byte local holds a data pointer at +0 and callback at +0x2c.
   Reusing the halfword temporary for data[1] preserves the PAL load/store
