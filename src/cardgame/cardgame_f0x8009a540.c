/*
 * CARDGAME:0x8009a540 CARDGAME_F0x8009a540
 * 112 bytes at CARDGAME.PRO offset 0x17890 (overlay loaded at 0x80082cb0).
 *
 ...
 *  Link        .text at 0x8009a540
 *  Symbols     D_8004df9c=0x8004df9c
 *  Compare     112 bytes from 0x8009a540 against the PAL overlay
 *  Verify      python tools/card_verify.py --only CARDGAME:0x8009a540
 */
/*
