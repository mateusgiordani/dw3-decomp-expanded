/*
 * CARDGAME:0x8008dd38 CARDGAME_F0x8008dd38
 * 136 bytes at CARDGAME.PRO offset 0xb088 (overlay loaded at 0x80082cb0).
 *
 ...
 *  Link        .text at 0x8008dd38
 *  Symbols     CARDGAME_F0x8008db7c=0x8008db7c CARDGAME_F0x8008dc70=0x8008dc70
 *              CARDGAME_F0x800915d4=0x800915d4
 *  Compare     136 bytes from 0x8008dd38 against the PAL overlay
 *  Verify      python tools/card_verify.py --only CARDGAME:0x8008dd38
 */

#include "common/types.h"

/*
 * portable C recovery (rev 2).
 *
